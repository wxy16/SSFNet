...
def train_aug(img, mask):
    ...
    crop_aug = Compose([RandomScale(scale_list=[0.5, 0.75, 1.0, 1.25, 1.5, 1.75, 2.0], mode='value'),
                         SmartCropV1(crop_size=512, max_ratio=0.75, ignore_index=255, nopad=False)])
    #crop_aug = SmartCropV1(crop_size=512, max_ratio=0.75, ignore_index=255, nopad=False)
